import { Card, Container, Row, Col, CardBody, Breadcrumb, BreadcrumbItem, Spinner, Form, FormGroup, Label, Input, Button } from "reactstrap";
...
const Login = ({is_login}) => {
  ...
  const handleSubmit = (e) => {
    ...
    Axios.post('/api/v1/user/register', querystring.stringify(values))
      .then(response => {
  ...
  return (
    <BaseLayout
      ...
      metaDescription="Register akun baru">
            ...
            <Card>
              <CardBody>
                ...
                <FormGroup>
                  ...
                  <FormGroup>
                    { !loadingProses &&
                    <Button color="primary" className="btn-block">Daftar</Button>										
                    }
                    { loadingProses &&
