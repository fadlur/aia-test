...
export default async (req, res) => { 
  ...
  try {
    ...
    formData.append('content', reqParse.fields.content)
    formData.append('status', reqParse.fields.status);
    formData.append('type', reqParse.fields.type);
    
    const axiosRes = await axiosInstance.post('/admin/blog', formData, { headers: header });
